...
export default class CreateCategory extends Component {
    ...
    if (this.state.category_name !== '' ) {
      ...
      if (this.state.UpdateId == null) {
        ...
        let insertCat = async () => {
          ...
          let response = await axios.post('/Category/add', obj, {
            headers:
            {
        ...
        let updateCat = async () => {
          let response = await axios.post('/Category/update/' + this.state.UpdateId, obj, {
            headers:
            {
              admin_token: this.token
            }
  ...
  delete(id) {
    ...
    let del = async () => {
      let response = await axios.get('/Category/delete/' + id, {
        headers:
        {
          admin_token: this.token
        }
