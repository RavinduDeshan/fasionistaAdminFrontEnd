...
export default class viewproduct extends Component {
    ...
    getProduct() {
        ...
        axios.get('/product/manager/' + this.props.match.params.id, {
            headers:
            {
                manager_token: token
    ...
    getOrders() {
        ...
        axios.get('/order/getbyProduct/' + this.props.match.params.id, {
            headers:
            {
                manager_token: token
    ...
    validateUser() {
        ...
        axios.get('/login/manager-token-validate', {
                ...
                await axios.post('/product/upload', formData, {
                    ...
                    axios.get('/login/manager-token-validate', {
                        ...
                        Swal.fire({
                            ...
                            html:
                                '<h4>Last Session Details</h4><br/><b>User ID :</b> ' + localStorage.getItem("id") + '<br/>' +
                                'Please Log In again and come back to this page to Continue. <br/><a class="btn btn-success" href="http:///manager-Sign-In/" target="_blank">Log In Here</a>',
                            showConfirmButton: false,
                            timer: 10000,
                            backdrop: `
          rgba(255,0,0,0.4)`
    ...
    onSubmit = async (e) => {
        ...
        axios.post('/product/update/' + this.props.match.params.id, product, {
            headers:
            {
                manager_token: token
