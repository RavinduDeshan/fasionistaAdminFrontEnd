...
export default class productList extends Component {
  ...
  getTopDiscountProducts() {
    ...
    axios.get('/product/top-discount', {
      headers:
      {
        manager_token: token
